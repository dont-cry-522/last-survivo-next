...
class Loadout {
    constructor(game) {
        ...
        this.panel.innerHTML=`<div class="loadout-inner"><p class="loadout-eyebrow">林地远征 / 武器进阶 13</p><h1>这次，带什么出发？</h1><p class="loadout-intro">2 级强化武器，3 级选择专属分支。扫射或重弹、扩散或集中、火径或分裂——本局走哪条路线？</p><p class="loadout-guide"><a href="skills.html">查看 64 个技能特效 ↗</a></p><div class="weapon-choices" role="group" aria-label="武器"></div><button class="loadout-start" type="button">带上连发枪 · 出发</button><p class="loadout-help">电脑：1 / 2 / 3 选择 · Enter 出发 · WASD 移动 · Shift 冲刺<br>手机：点选武器 · 左侧摇杆移动 · 右侧冲刺</p></div>`;
