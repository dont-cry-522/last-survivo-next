...
class Loadout {
    constructor(game) {
        ...
        this.panel.innerHTML=`<div class="loadout-inner"><p class="loadout-eyebrow">林地远征 / 森林地图 10</p><h1>这次，带什么出发？</h1><p class="loadout-intro">5120 × 2880 森林：中央营地 · 古木密林 · 雾溪湿地 · 断墙遗迹。自动攻击，树干需要绕行。</p><p class="loadout-guide"><a href="skills.html">查看 64 个技能特效 ↗</a></p><div class="weapon-choices" role="group" aria-label="武器"></div><button class="loadout-start" type="button">带上连发枪 · 出发</button><p class="loadout-help">电脑：1 / 2 / 3 选择 · Enter 出发 · WASD 移动 · Shift 冲刺<br>手机：点选武器 · 左侧摇杆移动 · 右侧冲刺</p></div>`;
