...
class Loadout {
    constructor(game) {
        ...
        this.panel.innerHTML=`<div class="loadout-inner"><p class="loadout-eyebrow">林地远征 / 武器样稿 04</p><h1>这次，带什么出发？</h1><p class="loadout-intro">三种武器，三种战斗节奏。靠近敌人后自动攻击。</p><div class="weapon-choices" role="group" aria-label="武器"></div><button class="loadout-start" type="button">带上连发枪 · 出发</button><p class="loadout-help">电脑：1 / 2 / 3 选择 · Enter 出发 · WASD 移动 · Shift 冲刺<br>手机：点选武器 · 左侧摇杆移动 · 右侧冲刺</p></div>`;
